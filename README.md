...
Please follow a consistent commit/message style.

---

## License

Is repo ke liye default **MIT** license use kar sakte ho (agar chahiye to). Add a `LICENSE` file.

---

## Contact

Akhilesh — agar README mein koi cheez change chahiye to batao, main turant update kar dunga.

---

*README generated by ChatGPT — modify the env vars and scripts to match your exact project structure.*
